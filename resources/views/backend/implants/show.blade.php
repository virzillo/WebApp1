...
<div class="card card-custom gutter-b ">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            ...
            <form method="POST" action="{{ route('implant.update', $implant->id) }}"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control kt-select2 select2" id="kt_select2_3" name="category_id">
                            ...
                            @foreach($categories as $category)
                                @if($implant->category->parent_id==$category->id)
                ...
                <div class="checkbox-inline">
                    @foreach($services as $service)
                        <label class="checkbox">
                            <label class="checkbox">
                                @foreach($implant->service as $item)
                                    <?php $check='';?>
        ...
        <div class="col-lg-12">
            <div class="form-group">
                ...
                <textarea class="form-control" id="descrizione"
                    name="descrizione">{{ $implant->descrizione }}</textarea>
                <span class="form-text text-muted"> </span>
            </div>
            <div class="form-group">
                <label>Testo:</label>
                <textarea class="form-control" id="testo" name="testo">{{ $implant->testo }}</textarea>
                <span class="form-text text-muted"> </span>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="form-group row">
                <div class="col-lg-6">
                    ...
                    <textarea class="form-control" id="condizioni_pagamento"
                        name="condizioni_pagamento">{{ $implant->condizioni_pagamento }}</textarea>
                    <span class="form-text text-muted"> </span>
                </div>
                <div class="col-lg-6">
                    <label>Condizioni generali:</label>
                    <textarea class="form-control" id="condizioni_generali"
                        name="condizioni_generali">{{ $implant->condizioni_generali }}</textarea>
                    <span class="form-text text-muted"> </span>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="form-group row">
                <div class="col-lg-6">
                    ...
                    <input type="text" class="form-control" placeholder="inserisci meta titolo" maxlength="70"
                        id="meta_titolo" name="meta_titolo" value="{{ $implant->meta_titolo }}">
                ...
                <div class="col-lg-6">
                    ...
                    <input type="text" class="form-control" placeholder="inserisci meta descrizione" maxlength="160"
                        id="meta_descrizione" name="meta_descrizione" value="{{ $implant->meta_descrizione }}">
            ...
            <div class="form-group">
                ...
                <input id="kt_tagify_1" class="form-control tagify" name='meta_keywords' placeholder="scrivi..."
                    value="{{ $implant->meta_keywords }}" data-blacklist='.NET,PHP' />
        ...
        <div class="col-lg-12">
            <div class="form-group ">
                ...
                <div class="image-input image-input-outline" id="kt_image_4"
                    style="background-image: url({{ url('/storage/') }}/{{ $implant->immagine }})">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-2 col-sm-2 ">
                    <span class="switch switch-outline switch-icon switch-info">
                        <label>
                            <input type="checkbox"
                                checked="{{ ($implant->illuminato==='on') ?  'checked' :  ' ' }}"
                                name="illuminato">
                            <span></span>
                        </label>
                    </span>
                ...
                <div class="col-lg-2 col-sm-2">
                    <span class="switch switch-outline switch-icon switch-success">
                        <label>
                            <input type="checkbox"
                                checked=" {{ ($implant->pubblicato==='on') ?  'checked' :  ' ' }}"
                                name="pubblicato">
                ...
                <div class="col-lg-2 col-sm-2">
                    <span class="switch switch-outline switch-icon switch-warning">
                        <label>
                            <input type="checkbox"
                                checked=" {{ ($implant->evidenza==='on') ?  'checked' :  ' ' }}"
                                name="evidenza">
                            <span></span>
                        </label>
                    </span>
        ...
        <div class="card-footer">
            <div class="row">
                ...
                <div class="col-lg-6 text-right">
                    <a href="{{route('implant.index')}}" type="button" class="btn btn-secondary">Back</a>
                    <button type="submit" class="btn btn-primary mr-2">Salva</button>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function () {
        var id = <?=json_encode($implant->category->parent_id)?> ;
