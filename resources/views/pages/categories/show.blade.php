    ...
    <div class="col-xl-4">
        <div class="card card-custom gutter-b card-stretch">
            ...
            <div class="card-body">
             ...
             <form method="POST" action="{{ route('modifica.categoria' , $editcategory->id) }}">
                ...
                <div class="card-body">
                    <div class="form-group row">
                            ...
                            <label>Titolo:</label>
                            <input type="text" class="form-control form-control-lg form-control-solid" placeholder="inserisci titolo" name="titolo" value="{{$editcategory->titolo}}">
