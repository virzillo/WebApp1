...
<div class="card card-custom card-stretch">
    ...
    <div class="card-header py-3">
        <div class="card-title align-items-start flex-column">
            <h3 class="card-label font-weight-bolder text-dark">Crea Progetto </h3>
    ...
    <form class="form">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <label class="col-xl-3 col-lg-3 col-form-label text-right">Testo</label>
                <div class="col-lg-9 col-xl-6">
                    <input type="text" class="form-control form-control-lg form-control-solid" value="" placeholder="Testo" />
            ...
            <div class="form-group row">
                <label class="col-xl-3 col-lg-3 col-form-label text-right">Pubblica</label>
                <div class="col-lg-9 col-xl-6">
            ...
            <div class="form-group row">
                <label class="col-xl-3 col-lg-3 col-form-label text-right">Aggiungi servizi</label>
                <div class="col-lg-9 col-xl-6">
                    <select class="form-control kt-select2 select2" id="kt_select2_1" name="role">
